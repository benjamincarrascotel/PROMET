...
<aside class="app-sidebar">
	...
	<ul class="side-menu app-sidebar3">
		...
		@if(auth()->user()->superadmin)
			...
			<li class="slide">
				<a class="side-menu__item"  href="{{route('activo.trazabilidad')}}">
					...
					<span class="side-menu__label">Trazabilidad</span>
				</a>
			</li>
		...
		@if(auth()->user()->superadmin)
			...
			<li class="slide">
				<a class="side-menu__item"  href="{{route('contrato.create')}}">
					<svg class="side-menu__icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M13 3H5v18h10v2H5a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h10.414L21 6.586V14h-2V9h-4a2 2 0 0 1-2-2V3Zm6 16v-2h2v2h2v2h-2v2h-2v-2h-2v-2h2Zm-.414-12L15 3.414V7h3.586Z"/></svg>			
