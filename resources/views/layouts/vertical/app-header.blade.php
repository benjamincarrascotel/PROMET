								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
									...
									<div class="text-center">
										<form id="logout-form" action="{!! route('logout') !!}" method="post">
											@csrf
											<a class="side-menu__item btn btn-primary" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
												...
												&nbsp;
												<span class="side-menu__label" style="color: black !important;">
													<b>Cerrar sesión</b>
												</span>
											</a>
										</form>
