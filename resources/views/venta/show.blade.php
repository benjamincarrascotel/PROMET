...
@section('content')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0 text-primary">Vista de Venta [ {{"ID : ".$venta->id}} ]  -  [ {{"ACTIVO ID : ".$venta->activo->id}} ]  -  [ {{"COD. INTERNO : ".$venta->activo->codigo_interno}} ]</h4></h4>
        </div>
                    ...
                    <form action="{{ route('venta.update', $venta->id) }}" method="post" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                ...
                                <textarea class="form-control mb-4 " name='observaciones' id="observaciones" placeholder="Observaciones" rows="3" maxlength="249" >{{$venta->observaciones}}</textarea>
                            </div>
                        </div>
                            ...
                            <div class=" tab-menu-heading p-0 bg-light">
                                <div class="tabs-menu1 ">
                                    ...
                                    <ul class="nav panel-tabs">
                                        ...
                                        <li><a href="#tab_2" data-bs-toggle="tab">EN CLIENTE (VENDIDO)</a></li>
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Firma: 
                                                        @if($cambios_fases[1][0]->firma)
                                                            <a target="_blank" href="{{ $_ENV['APP_URL'].'/storage/ventas/'.$venta->id.'/'.$cambios_fases[1][0]->firma }}">
                                                ...
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Firma: 
                                                        @if($cambios_fases[2][0]->firma)
                                                            <a target="_blank" href="{{ $_ENV['APP_URL'].'/storage/ventas/'.$venta->id.'/'.$cambios_fases[2][0]->firma }}">
                                                                <svg width="70%" height="22" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" class="si-glyph si-glyph-checked"><path d="M3.432 6.189a1 1 0 0 1 1.415 0L6.968 8.31l6.179-6.179a.99.99 0 0 1 1.401.013l2.122 2.122a.991.991 0 0 1 .014 1.4l-9.022 9.021a.99.99 0 0 1-1.401-.014l-4.95-4.95a.998.998 0 0 1 0-1.413l2.121-2.121Z" fill="#eb970a" fill="#434343"  class="si-glyph-fill" fill-rule="evenodd"/></svg>
                                                            </a>
                                                        @else
                                                            <svg width="70%" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999" xml:space="preserve"><path style="fill:#ff6465" d="m384.955 256 120.28-120.28c9.019-9.019 9.019-23.642 0-32.66L408.94 6.765c-9.019-9.019-23.642-9.019-32.66 0L256 127.045 135.718 6.765c-9.019-9.019-23.642-9.019-32.66 0L6.764 103.058c-9.019 9.019-9.019 23.642 0 32.66l120.28 120.28L6.764 376.28c-9.019 9.019-9.019 23.642 0 32.66l96.295 96.294c9.019 9.019 23.642 9.019 32.66 0l120.28-120.28 120.28 120.28c9.019 9.019 23.642 9.019 32.66 0l96.295-96.294c9.019-9.019 9.019-23.642 0-32.66L384.955 256z"/></svg>                                        
                                    ...
                                    <div class="tab-pane" id="tab_3">
                                        @if(isset($cambios_fases[3]))
                                            <div class="row">
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Etapa anterior: <b>EN CLIENTE (VENDIDO)</b></p>
                                                </div>
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Firma: 
                                                        @if($cambios_fases[3][0]->firma)
                                                            <a target="_blank" href="{{ $_ENV['APP_URL'].'/storage/ventas/'.$venta->id.'/'.$cambios_fases[3][0]->firma }}">
                                                                <svg width="70%" height="22" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" class="si-glyph si-glyph-checked"><path d="M3.432 6.189a1 1 0 0 1 1.415 0L6.968 8.31l6.179-6.179a.99.99 0 0 1 1.401.013l2.122 2.122a.991.991 0 0 1 .014 1.4l-9.022 9.021a.99.99 0 0 1-1.401-.014l-4.95-4.95a.998.998 0 0 1 0-1.413l2.121-2.121Z" fill="#eb970a" fill="#434343"  class="si-glyph-fill" fill-rule="evenodd"/></svg>
                                                            </a>
                                                        @else
                                                            <svg width="70%" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999" xml:space="preserve"><path style="fill:#ff6465" d="m384.955 256 120.28-120.28c9.019-9.019 9.019-23.642 0-32.66L408.94 6.765c-9.019-9.019-23.642-9.019-32.66 0L256 127.045 135.718 6.765c-9.019-9.019-23.642-9.019-32.66 0L6.764 103.058c-9.019 9.019-9.019 23.642 0 32.66l120.28 120.28L6.764 376.28c-9.019 9.019-9.019 23.642 0 32.66l96.295 96.294c9.019 9.019 23.642 9.019 32.66 0l120.28-120.28 120.28 120.28c9.019 9.019 23.642 9.019 32.66 0l96.295-96.294c9.019-9.019 9.019-23.642 0-32.66L384.955 256z"/></svg>                                        
                                                ...
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Firma: 
                                                        @if($cambios_fases[4][0]->firma)
                                                            <a target="_blank" href="{{ $_ENV['APP_URL'].'/storage/ventas/'.$venta->id.'/'.$cambios_fases[4][0]->firma }}">
                                                                <svg width="70%" height="22" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" class="si-glyph si-glyph-checked"><path d="M3.432 6.189a1 1 0 0 1 1.415 0L6.968 8.31l6.179-6.179a.99.99 0 0 1 1.401.013l2.122 2.122a.991.991 0 0 1 .014 1.4l-9.022 9.021a.99.99 0 0 1-1.401-.014l-4.95-4.95a.998.998 0 0 1 0-1.413l2.121-2.121Z" fill="#eb970a" fill="#434343"  class="si-glyph-fill" fill-rule="evenodd"/></svg>
                                                            </a>
                                                        @else
                                                            <svg width="70%" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999" xml:space="preserve"><path style="fill:#ff6465" d="m384.955 256 120.28-120.28c9.019-9.019 9.019-23.642 0-32.66L408.94 6.765c-9.019-9.019-23.642-9.019-32.66 0L256 127.045 135.718 6.765c-9.019-9.019-23.642-9.019-32.66 0L6.764 103.058c-9.019 9.019-9.019 23.642 0 32.66l120.28 120.28L6.764 376.28c-9.019 9.019-9.019 23.642 0 32.66l96.295 96.294c9.019 9.019 23.642 9.019 32.66 0l120.28-120.28 120.28 120.28c9.019 9.019 23.642 9.019 32.66 0l96.295-96.294c9.019-9.019 9.019-23.642 0-32.66L384.955 256z"/></svg>                                        
                                                ...
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Firma: 
                                                        @if($cambios_fases[5][0]->firma)
                                                            <a target="_blank" href="{{ $_ENV['APP_URL'].'/storage/ventas/'.$venta->id.'/'.$cambios_fases[5][0]->firma }}">
                                                                <svg width="70%" height="22" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" class="si-glyph si-glyph-checked"><path d="M3.432 6.189a1 1 0 0 1 1.415 0L6.968 8.31l6.179-6.179a.99.99 0 0 1 1.401.013l2.122 2.122a.991.991 0 0 1 .014 1.4l-9.022 9.021a.99.99 0 0 1-1.401-.014l-4.95-4.95a.998.998 0 0 1 0-1.413l2.121-2.121Z" fill="#eb970a" fill="#434343"  class="si-glyph-fill" fill-rule="evenodd"/></svg>
                                                            </a>
                                                        @else
                                                            <svg width="70%" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999" xml:space="preserve"><path style="fill:#ff6465" d="m384.955 256 120.28-120.28c9.019-9.019 9.019-23.642 0-32.66L408.94 6.765c-9.019-9.019-23.642-9.019-32.66 0L256 127.045 135.718 6.765c-9.019-9.019-23.642-9.019-32.66 0L6.764 103.058c-9.019 9.019-9.019 23.642 0 32.66l120.28 120.28L6.764 376.28c-9.019 9.019-9.019 23.642 0 32.66l96.295 96.294c9.019 9.019 23.642 9.019 32.66 0l120.28-120.28 120.28 120.28c9.019 9.019 23.642 9.019 32.66 0l96.295-96.294c9.019-9.019 9.019-23.642 0-32.66L384.955 256z"/></svg>                                        
                                                ...
                                                <div class="col">
                                                    <p class="fs-14 font-weight-bold">Firma: 
                                                        @if($cambios_fases[6][0]->firma)
                                                            <a target="_blank" href="{{ $_ENV['APP_URL'].'/storage/ventas/'.$venta->id.'/'.$cambios_fases[6][0]->firma }}">
                                                                <svg width="70%" height="22" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" class="si-glyph si-glyph-checked"><path d="M3.432 6.189a1 1 0 0 1 1.415 0L6.968 8.31l6.179-6.179a.99.99 0 0 1 1.401.013l2.122 2.122a.991.991 0 0 1 .014 1.4l-9.022 9.021a.99.99 0 0 1-1.401-.014l-4.95-4.95a.998.998 0 0 1 0-1.413l2.121-2.121Z" fill="#eb970a" fill="#434343"  class="si-glyph-fill" fill-rule="evenodd"/></svg>
                                                            </a>
                                                        @else
                                                            <svg width="70%" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999" xml:space="preserve"><path style="fill:#ff6465" d="m384.955 256 120.28-120.28c9.019-9.019 9.019-23.642 0-32.66L408.94 6.765c-9.019-9.019-23.642-9.019-32.66 0L256 127.045 135.718 6.765c-9.019-9.019-23.642-9.019-32.66 0L6.764 103.058c-9.019 9.019-9.019 23.642 0 32.66l120.28 120.28L6.764 376.28c-9.019 9.019-9.019 23.642 0 32.66l96.295 96.294c9.019 9.019 23.642 9.019 32.66 0l120.28-120.28 120.28 120.28c9.019 9.019 23.642 9.019 32.66 0l96.295-96.294c9.019-9.019 9.019-23.642 0-32.66L384.955 256z"/></svg>                                        
    ...
    <div class="row">
        <div class="card mt-4">
            <div class="card-header ">
                <div class="card-title">Registro de traspasos de la venta</div>
            </div>
            @if(count($traspasos))
                @foreach ($traspasos as $traspaso)
                    ...
                    @endif
                        ...
                        @if($traspaso->proceso_cambio_flag)
                            <h3 class="card-title text-black"><i class="fa fa-money text-black"></i> MONTO ANTERIOR: {{$traspaso->precio_venta_anterior}} [{{$traspaso->tipo_moneda_anterior}}]</h3>
                        @else
