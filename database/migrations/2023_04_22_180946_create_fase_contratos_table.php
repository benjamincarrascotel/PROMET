...
class CreateFaseContratosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Tabla Fase Contratos
        Schema::create('fase_contratos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fase_contratos');
    }
}
